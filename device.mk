...
$(call inherit-product, vendor/oneplus/IMS-ivan/mtk-ims.mk)
...
PRODUCT_COPY_FILES += \
    device/oneplus/ivan/bluetooth/audio/config/sysbta_audio_policy_configuration.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sysbta_audio_policy_configuration.xml \
    device/oneplus/ivan/bluetooth/audio/config/sysbta_audio_policy_configuration_7_0.xml:$(TARGET_COPY_OUTY_SYSTEM)/etc/sysbta_audio_policy_configuration_7_0.xml
...
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/vendor_overlay/etc/fstab.mt6877:$(TARGET_COPY_OUT_RAMDISK)/fstab.mt6893
